...
if (isset($_POST['add'])) {
    ...
    $year = $_POST['year'];
    $conn->query("INSERT INTO education (school, program, year) VALUES ('$school','$program','$year')");
}
...
<form method="post">
  ...
  <textarea name="program" placeholder="Program / Course"></textarea>
  <input type="text" name="year" placeholder="Year (e.g. 2020 - 2024)">
...
while($row = $result->fetch_assoc()) {
    ...
    echo "<a class='delete-btn' href='?delete=".$row['id']."' onclick=\"return confirm('Are you sure?');\">🗑 Delete</a>";
    echo "</div>";
}
?>
